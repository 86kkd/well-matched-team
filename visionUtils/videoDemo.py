...
class detectModel():
    ...
    def detect(self,img):
        with torch.inference_mode():
            return generate_detection(img, model = self.model)
class vinoModel():
    ...
    def detect(self,image):
        ...
        seg_out = preds[self.seg_out_ir]  # drive_area_seg
        lan_out = preds[self.lan_out_ir]  # lane_line_seg
